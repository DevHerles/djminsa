...
function TodoSidebarContent(props)
{
    ...
    const labels = useSelector(({usersApp}) => usersApp.labels);
    const folders = useSelector(({usersApp}) => usersApp.folders);
    const filters = useSelector(({usersApp}) => usersApp.filters);
