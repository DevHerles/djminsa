...
function SidebarContent(props) {
  ...
  const labels = useSelector(({ affidavitHealthApp }) => affidavitHealthApp.labels);
  const folders = useSelector(({ affidavitHealthApp }) => affidavitHealthApp.folders);
  const filters = useSelector(({ affidavitHealthApp }) => affidavitHealthApp.filters);
