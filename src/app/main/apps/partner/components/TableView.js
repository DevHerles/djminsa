...
function TableView(props)
{
    ...
    const records = useSelector(({partnerApp}) => partnerApp.records.data);
    ...
    {
        props.history.push('/apps/'+ path +'/' + item._id);
    }
                            ...
                            .map(record => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCellUI field={record.image}/>
                                        <TableCellUI field={record.name}/>
                                        <TableCellUI field={record.first_name}/>
                                        <TableCellUI field={record.last_name}/>
