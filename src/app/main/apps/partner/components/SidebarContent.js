...
function TodoSidebarContent(props)
{
    ...
    const labels = useSelector(({partnerApp}) => partnerApp.labels);
    const folders = useSelector(({partnerApp}) => partnerApp.folders);
    const filters = useSelector(({partnerApp}) => partnerApp.filters);
        ...
        <FuseAnimate animation="transition.slideUpIn" delay={400}>
            ...
            <div className="flex-auto border-l-1 border-solid">
                ...
                <div className="p-24">
                    <Button
                        onClick={() => {
                            console.log('dispatch(Actions.openNewTodoDialog());');
                        }}
                        variant="contained"
                        color="primary"
                        className="w-full"
